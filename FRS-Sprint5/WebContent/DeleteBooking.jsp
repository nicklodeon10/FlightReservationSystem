...
<body>
	...
	<div class="container">
		...
		<div class="row">
			<div class="input-field col s6 offset-s3">
				<input id="id" type="number" class="validate"> <label
					class="active" for="booking_id">Booking Id:</label>
			</div>
		</div>
	...
	<button class="btn waves-effect waves-teal open-button col s6 center"
