	...
	<div class="container center">
		<ul class="collection with-header">
			...
			<li class="collection-item">
				<div class="row">
					<div class="col s5">
						<div class="carrierName">Carrier Name:</div>
						<div class="flightModel">FlightModel:</div>
						<div class="flightNumber">Flight Number:</div>
						<div class="availableSeats">Available Seats:</div>
					</div>
					<div class="col s5">
						<div class="sourceAirport">Source:</div>
						<div class="destinationAirport">Destination:</div>
						<div class="departureTime">Departure:</div>
