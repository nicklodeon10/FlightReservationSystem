						...
						<form:form action="scheduledFlightRemove" method="GET">
							<div class="row">
								...
								<div class="input-field col s12">
									<input id="schedule_flight_number" type="number" name="scheduled_flight_id"
										class="validate" value="${scheduledFlight.scheduleFlightId}"
										readonly></input> <label for="schedule_flight_number">Flight
										Number</label>
								</div>
								<div class="input-field col s12">
