	...
	<div class="container">
		<div class="row">
			<div class="card col s8 offset-s2 center">
				<form:form action="addScheduleFlight" method="POST" modelAttribute="scheduleFlight">
					<div class="row">
						<h5>Add Flight</h5>
						<br>
						<div class="input-field col s12">
							<form:input id="schedule_flight_number" type="number" class="validate"
								path="scheduleFlightId"></form:input>
							<label for="schedule_flight_number">Flight Number</label>
						</div>
						<div class="input-field col s12">
							<input id="source_airport" type="text" class="validate"
								name="source_airport"></input>
							<label for="source_airport">Source Airport</label>
						</div>
						<div class="input-field col s12">
							<input id="destination_airport" type="text" class="validate"
								name="destination_airport"></input>
